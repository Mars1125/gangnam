  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="components/productos.php">CATALOGO</a>
        </li>
        <li class="nav-item">
      ...
      <div class="row d-md-flex d-sm-flex  me-2" role="search">
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 d-sm-flex  p-0">
          <li class="nav-item dropdown lista-nav-li p-1 col-lg-2 col-md-2 col-sm-4">
            <a class="nav-link dropdown-toggle lista-nav-li btn p-1" href="#" role="button" data-bs-toggle="dropdown"
              aria-expanded="false"> <i class="fa-solid fa-magnifying-glass fa-lg"></i>
            </a>
            <ul class="dropdown-menu lista-nav-li">
              <li><a href="./templates/sesion.php" class="btn p-1">Iniciar Sesion</a></li>
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 d-sm-flex  p-0">
          <a class="btn position-relative p-2" type="submit"><i class="fa-solid fa-cart-shopping fa-lg"></i><span
